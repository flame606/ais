defmodule ExAIS.Data.Ais do
  ...
  defp parse_message(msg_type, payload) when msg_type == 4 or msg_type == 11 do
  ...
  defp parse_message(msg_type, payload) when valid_type_5(msg_type, payload) do
    ...
    %{
      ...
      call_sign: String.trim(SixBit.get_string(call_sign, 42)),
      name: String.trim(SixBit.get_string(name, 120)),
      ship_type: ship_type,
      ...
      position_fix_type: position_fix_type,
      eta: %{
        month: eta_month,
        day: eta_day,
        hour: eta_hour,
      ...
      destination: String.trim(SixBit.get_string(destination, 120)),
      dte: dte,
      spare: spare
    }
  end
  ...
  defp parse_message(
         msg_type,
         <<repeat_indicator::2, mmsi::30, spare::2, id_1::30, seq_1::2, id_2::30, seq_2::2,
           id_3::30, seq_3::2, id_4::30, seq_4::2, _::bitstring>>
       )
       when msg_type == 7 or msg_type == 13 do
    %{
      repeat_indicator: repeat_indicator,
      mmsi: mmsi,
      spare: spare,
  ...
  defp parse_message(
         msg_type,
         <<repeat_indicator::2, mmsi::30, spare::2, id_1::30, seq_1::2, _::bitstring>>
       )
       when msg_type == 7 or msg_type == 13 do
    %{
      repeat_indicator: repeat_indicator,
  ...
  defp parse_message(msg_type, payload) when msg_type == 10 do
    <<repeat_indicator::2, mmsi::30, spare1::2, destination_id::30, spare2::2>> = payload
  ...
  defp parse_message(msg_type, payload) when msg_type == 14 do
  ...
  defp parse_message(
         ...
         <<repeat_indicator::2, mmsi::30, spare1::2, destination_id_1::30, msg_type_1::6,
           slot_offset_1::12, spare2::2, msg_type_1_2::6, slot_offset_1_2::12, spare3::2,
           destination_id_2::30, msg_type_2::6, slot_offset_2::12, spare4::2, _::bitstring>>
       )
       when msg_type == 15 do
    %{
      repeat_indicator: repeat_indicator,
  ...
  defp parse_message(
         msg_type,
         <<repeat_indicator::2, mmsi::30, spare1::2, destination_id_1::30, msg_type_1::6,
           slot_offset_1::12, spare2::2, msg_type_1_2::6, slot_offset_1_2::12, _::bitstring>>
       )
       when msg_type == 15 do
    %{
      repeat_indicator: repeat_indicator,
  ...
  # Assignment mode command (Message 16) - 144 bit version
  ...
  # Assignment mode command (Message 16) - 96 bit version
  # !AIVDM,1,1,,B,@6STUk004lQ206bCKNOBAb6SJ@5s,0*74
  defp parse_message(
         msg_type,
         <<repeat_indicator::2, mmsi::30, spare::2, destination_a_id::30, offset_a::12,
  ...
  defp parse_message(
         msg_type,
         <<repeat_indicator::2, mmsi::30, spare1::2, longitude::integer-signed-size(18),
  ...
  defp parse_message(msg_type, payload) when msg_type == 18 do
    <<repeat_indicator::2, mmsi::30, spare1::8, sog::10, position_accuracy::1,
      longitude::integer-signed-size(28), latitude::integer-signed-size(27), cog::12,
  ...
  defp parse_message(msg_type, payload) when msg_type == 21 do
    ...
    name = String.trim(SixBit.get_string(aid_name, 120))
  ...
  defp parse_message(msg_type, payload) when msg_type == 22 do
  ...
  defp parse_message(
    ...
    %{
      ...
      ship_type: ship_type,
      vendor_id: String.trim(SixBit.get_string(vendor_id, 42)),
      call_sign: String.trim(SixBit.get_string(call_sign, 42)),
      dimension_a: dimension_a,
      dimension_b: dimension_b,
      dimension_c: dimension_c,
  ...
  defp parse_message(msg_type, payload) when msg_type == 25 do
    <<repeat_indicator::2, mmsi::30, destination_indicator::1, binary_data_flag::1,
